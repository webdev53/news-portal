...
class AdminSubCategoryController extends Controller
{
    ...
    public function store(Request $request){
      ...
      return redirect()->route('admin_sub_category_show')->with('success', 'Sub Category is created successfully');
    }
    ...
    public function update(Request $request, $id){
      ...
      return redirect()->route('admin_sub_category_show')->with('success', 'Sub Category is updated successfully');
    }
    ...
    public function delete($id){
      ...
      return redirect()->route('admin_sub_category_show')->with('success', 'Sub Category is deleted successfully');
    }
}