        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="form-group mb-3">
                ...
                <textarea name="post_detail" class="form-control snote" id="" cols="30" rows="10">{{ $post_single->post_detail }}</textarea>
              </div>

              <div class="form-group mb-3">
                <label>Existing Post Photo *</label>
               <div>
                  <img src="{{ asset('uploads/'.$post_single->post_photo) }}" style="width:200px;" alt="">
               </div>
              </div>
